                                    ...
                                    MaterialPageRoute(
                                      builder: (context) {
                                        return CheckOutScreen(
                                          ...
                                          id: latestSessionsModel.counsellorId!,
                                          sessionId:
                                              latestSessionsModel.sessionId!,
                                          sessionTime:
                                              latestSessionsModel.sessionTime,
                                          sessionTopic:
                                              latestSessionsModel.sessionTopic,
                                          sessionDuration: latestSessionsModel
                                              .sessionDuration,
                                        );
                                      },
                                    ),
...
//     if (daysDifference < 0) {
//       return "Happened ${daysCount} days ago";
//     } else if (daysDifference == 0 && canJoin && daysCount == 0) {
//       return "Join Now";
//     } else if (daysDifference == 0) {
//       return "Starting today";
//     } else {
//       return "Starting in ${daysCount} days";
//     }
//   }
...
//     DateTime webinarDate = DateTime.parse(regdate!).toLocal(); // Parse and convert to local time
//     webinarDate = DateTime(webinarDate.year, webinarDate.month, webinarDate.day); // Ignore time
