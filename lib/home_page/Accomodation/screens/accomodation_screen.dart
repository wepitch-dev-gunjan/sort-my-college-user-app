...
//                     children: [
//                       AccommodationCard(
//                           data: data, onRefresh: getAllAccommodation),
//                     ],
//                   ),
//                 ),
//     );
...
//         //     ).then((result) {
//         //       if (result != null) {
//         //         log("Data from FilterScreen: $result");
//         //       }
//         //       onRefresh();
//         //     });
//         //   },
...
//       if (result != null) {
//         log("Data from FilterScreen: $result");
//         // Parse and set filters here
//         // For example: setState(() => appliedFilters = result);
//       }
//       onRefresh();
//     });
//   },
...
//                 final key = entry.key;
//                 final values = entry.value; // Assuming it's a list
//                 return Row(
//                   children: [
//                     ...values.map((value) {
//                       return Container(
...
//                       AccommodationCard(
//                         data: data,
//                         onRefresh: getAllAccommodation,
//                         appliedFilters: appliedFilters, // Pass filters here
//                       ),
//                     ],
//                   ),
//                 ),
                  ...
                  child: ListView(
                    children: [
                      AccommodationCard(
                        ...
                        onFiltersUpdated: _applyFilters, // Update filters
                      ),
                    ],
                  ),
                ),
...
class AccommodationCard extends StatelessWidget {
  ...
  const AccommodationCard({
    ...
    required this.onFiltersUpdated, // Initialize callback
  });
